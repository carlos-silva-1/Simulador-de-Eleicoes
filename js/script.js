...
function atualizarInterface() {
  ...
  //modificado para mostrar o nome do candidato
 ...
 * 
 * @param {string} value html contendo o número digitado
 */
 ...
 * Após o voto ser contabilizado, abre uma conexão com o servidor e
 * envia os votos.
 */
function confirmar() {
  ...
  if (etapas[etapaAtual + 1]) {
    ...
    httpc.send(JSON.stringify(votos));
